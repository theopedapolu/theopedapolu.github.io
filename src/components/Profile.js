...
function Profile() {
    return (
      <div id='About' className='flex justify-evenly flex-wrap bg-gray-50'>
      <div className='flex flex-1 flex-col items-center align-center font-lato text-gray-500'>
          <a href="." className=''>
      ...
      <div className='flex flex-1 flex-col items-left font-system-ui mr-10'>
